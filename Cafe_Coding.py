...
#print('bravo\033[1A', end='',flush=True)
#time.sleep(2)
#print('bravotest', end='')
...
while True:
    ...
    if r_n < 10:
        ...
        print('ERROR: Could not install packages due to an EnvironmentError: [WinError 5] アクセスが拒否されました。: C:\\Program Files\\Soreppoi\\Path')
